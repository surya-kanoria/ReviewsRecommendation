...
def build_dcnn_paper(batch_size, vocab_size, embeddings_size=48, filter_sizes=[10, 7], nr_of_filters=[6, 12],
...
def build_max_tdnn(batch_size, vocab_size, embeddings_size, filter_size, output_classes):
    l_in = lasagne.layers.InputLayer(
        shape=(batch_size, None),
    )
