...
def buildDCNNPaper(batch_size, vocab_size, embeddings_size=48, filter_sizes=[10, 7], nr_of_filters=[6, 12],
                   activations=["tanh", "tanh"], ktop=5, dropout=0.5, output_classes=2, padding='last'):
    ...
    l_conv1 = archives.dcnn.DCNN.convolutions.Conv1DLayerSplitted(
        l_embedding,
        nr_of_filters[0],
        filter_sizes[0],
    ...
    l_conv2 = archives.dcnn.DCNN.convolutions.Conv1DLayerSplitted(
        l_nonlinear1,
        nr_of_filters[1],
        filter_sizes[1],
        nonlinearity=lasagne.nonlinearities.linear,
...
def buildMaxTDNN(batch_size, vocab_size, embeddings_size, filter_size, output_classes):
    ...
    l_conv1 = archives.dcnn.DCNN.convolutions.Conv1DLayer(
        l_embedding,
        1,
        filter_size,
